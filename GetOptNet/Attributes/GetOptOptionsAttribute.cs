...
namespace NMaier.GetOptNet {
	...
	public sealed class GetOptOptionsAttribute : Attribute {
		...
		/// <summary>
		///  Defines the Usage statement for the program
		/// </summary>
		public string UsageStatement { get; set; } = string.Empty;
		...
		public ArgumentPrefixTypes UsagePrefix {
			...
			set {
				...
				{
					throw new ArgumentException("Usage prefix must be Dashes or Slashes", nameof(UsagePrefix));
				}
